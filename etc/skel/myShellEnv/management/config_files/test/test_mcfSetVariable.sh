...
test_mcfSetVariable() {
  ...
  ((mseCountAssert=mseCountAssert+1))
  mcfSetVariable "CONTAINER_WEBSERVER_NAME" "dev-teste" "${mseTMPDIR}/test/.config"
  local testResult=$(mcfPrintVariable "CONTAINER_WEBSERVER_NAME" "${mseTMPDIR}/test/.config")
  ...
  ((mseCountAssert=mseCountAssert+1))
  mcfSetVariable "CONTAINER_WEBSERVER_NAME" "dev-php-webserver" "${mseTMPDIR}/test/.config"
  local testResult=$(mcfPrintVariable "CONTAINER_WEBSERVER_NAME" "${mseTMPDIR}/test/.config")
  local testExpected="CONTAINER_WEBSERVER_NAME    =   dev-php-webserver"
  ...
  ((mseCountAssert=mseCountAssert+1))
  mcfSetSectionVariable "teste" "GIT_LOG_LENGTH" "30" "${mseTMPDIR}/test/.config"
  local testResult=$(mcfPrintSectionVariable "teste" "GIT_LOG_LENGTH" "${mseTMPDIR}/test/.config")
  ...
  ((mseCountAssert=mseCountAssert+1))
  mcfSetSectionVariable "teste" "GIT_LOG_LENGTH" "20" "${mseTMPDIR}/test/.config"
  local testResult=$(mcfPrintSectionVariable "teste" "GIT_LOG_LENGTH" "${mseTMPDIR}/test/.config")
  local testExpected="GIT_LOG_LENGTH              =   20"
